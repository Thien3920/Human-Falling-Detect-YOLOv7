...
import sys
sys.path.append('/media/ngocthien/DATA/DO_AN_TOT_NGHIEP/TRAIN/tools')
...
class SPPE_FastPose(object):
    ...
    def predict(self, image, bboxs, bboxs_scores):
        self.inp_h=320
        self.inp_w=256
        inps, pt1, pt2 = crop_dets(image, bboxs, self.inp_h, self.inp_w)#inps, pt1, pt2 = crop_dets(image, bboxs, self.inp_h, self.inp_w)
