...
class TinyYOLOv3_onecls(object):
    ...
    def __init__(self,
                 input_size=416,
                 config_file='/media/ngocthien/DATA/DO_AN_TOT_NGHIEP/Human-Falling-Detect-Tracks/Models/yolo-tiny-onecls/yolov3-tiny-onecls.cfg',
                 weight_file='/media/ngocthien/DATA/DO_AN_TOT_NGHIEP/Human-Falling-Detect-Tracks/Models/yolo-tiny-onecls/best-model.pth',
                 nms=0.2,
                 conf_thres=0.45,
                 device='cuda'):
